class TerminalResume {
  ...
  printWelcomeMessage(outputElement = this.output) {
    ...
    const welcome =
      "<h1 style='font-family: \"Fira Code\", monospace; font-size: 2.5rem; font-weight: 700; margin: 0 0 10px 0; color: var(--cyan, #00f3ff);'>HARI CHARAN</h1>" +
      this.wrapWithColor(divider + "\n", "#555555") +
      this.wrapWithColor(
        "            Hari Charan — Interactive Terminal Resume\n",
        "#888888"
      ) +
      this.wrapWithColor(
        "       EEE Engineer • Renewable Energy • Embedded Systems\n",
        "#666666"
      ) +
      this.wrapWithColor(divider + "\n\n", "#555555") +
  ...
  showHelp(outputElement = this.output) {
    ...
    const help = title + mainCommands + shortcuts;
...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "Hari Charan — Electrical & Electronics Engineer student",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "at VIT Chennai specializing in renewable energy, power",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "electronics, intelligent control systems, and ML models.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└──────────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   ANN-based MPPT controller for solar PV systems. Modeled",
  "#ffffff"
)}
${this.wrapWithColor("   single-diode arrays and trained feed-forward ANNs in MATLAB.", "#ff8c00")}

${this.wrapWithColor("⚡ Passion", "#ff8c00")}
${this.wrapWithColor(
  "   Building intelligent hardware-software systems that bridge",
  "#ffffff"
)}
${this.wrapWithColor(
  "   power electronics, embedded design, and AI-driven control.",
  "#ffffff"
)}

${this.wrapWithColor("⚡ Strengths", "#ff8c00")}
${this.wrapWithColor(
  "   PCB design, MATLAB/Simulink simulation, microcontroller",
  "#ffffff"
)}
${this.wrapWithColor("   programming, and neural network architectures.", "#ffffff")}
...
${this.wrapWithColor(
  "05/2025 – 07/2025 | Chennai, India | Guide: Dr. Sithartan",
  "#ffffff"
)}
${this.wrapWithColor(
  "VIT Chennai — Smart Grid & Renewable Energy Research Lab",
  "#98fb98"
)}
...
${this.wrapWithColor("Tools & Technologies:", "#00ffff")} ${this.wrapWithColor(
      "MATLAB, Simulink, Artificial Neural Networks (ANN), MPPT, Single-Diode Model, Boost Converter",
      "#87cefa"
    )}`;
...
${this.wrapWithColor("📅 Expected:", "#ff8c00")}    ${this.wrapWithColor(
      "May 2027",
      "#ffffff"
    )}
...
${this.wrapWithColor("   English (C2)  •  Hindi (C2)  •  Tamil (C2)  •  Kannada (C1)", "#ffffff")}
...
${this.wrapWithColor("│", "#ff8c00")}${this.wrapWithColor(
      " Engineering at the intersection of power & intelligence. ",
      "#ffffff"
    )}${this.wrapWithColor("│", "#ff8c00")}
${this.wrapWithColor(
  "╰──────────────────────────────────────────────────────────╯",
...
<span style="color: #00ffff;">Simulation & Design Tools</span>
• ${this.wrapWithColor("MATLAB", "#ffffff")}
• ${this.wrapWithColor("Simulink", "#ffffff")}
• ${this.wrapWithColor("LTspice", "#ffffff")}
• ${this.wrapWithColor("Keil Micro-Vision", "#ffffff")}
...
• ${this.wrapWithColor("Assembly Language", "#ffffff")}

<span style="color: #00ffff;">Hardware & PCB Design</span>
• ${this.wrapWithColor("KiCad", "#ffffff")}
• ${this.wrapWithColor("EasyEDA", "#ffffff")}
• ${this.wrapWithColor("Circuit Design", "#ffffff")}
• ${this.wrapWithColor("Sensor Interfacing", "#ffffff")}
• ${this.wrapWithColor("Microcontrollers", "#ffffff")}
• ${this.wrapWithColor("Microprocessors", "#ffffff")}
• ${this.wrapWithColor("Embedded Systems", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:hari2006charan@gmail.com" style="color: #ffffff; text-decoration: none;">hari2006charan@gmail.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://www.linkedin.com/in/hari-charan-v-a97b9228a" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com/in/hari-charan-v</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🐙", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://github.com/haricharan052006" target="_blank" style="color: #ffffff; text-decoration: none;">github.com/haricharan052006</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("📍", "#ff8c00")}  ${this.wrapWithColor(
      "Location:",
      "#ff8c00"
    )} ${this.wrapWithColor("Chennai, India", "#ffffff")}
...
${this.wrapWithColor("╰─────────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        image: "",
        technologies: ["KiCad", "PCB Design", "I2C", "Wearable"],
        demo: "",
        repo: "",
      },
      {
        title: "Cadence: Native Mobile Habit Tracking Application",
        description:
          "Cadence is a habit tracking app. A cross-platform standalone mobile application built with a 30-Day Performance Matrix, internal scroll clipping wrappers, localized client-side data persistence, and native file-sharing integrations for Excel sheet exportation.",
        image: "",
        technologies: ["Mobile", "Data Persistence", "Excel Export"],
        demo: "",
        repo: "https://github.com/haricharan052006/Cadence",
      },
      {
        title: "AI-ML Driven State Estimation for Smart Grid Applications",
        description:
          "Implemented an ANN-based power system state estimation model on the IEEE 14-bus system using MATLAB/MATPOWER, increasing robustness over traditional WLS methods.",
        image: "",
        technologies: ["MATLAB", "MATPOWER", "ANN", "Smart Grid"],
        demo: "#",
        repo: "",
      },
      {
        title: "Real-Time Power Monitoring and Power Factor Correction System",
        description:
      ...
      {
        title: "DC-DC Buck-Boost Converter Design and PCB Implementation",
        description:
          "Simulated an inverting buck-boost topology in MATLAB, analyzed voltage gain characteristics, and routed the functional schematic and PCB layout in EasyEDA.",
        image: "",
        technologies: ["MATLAB", "EasyEDA", "Power Electronics", "PCB"],
        demo: "",
        repo: "",
      },
      {
        ...
        description:
          "Developed an automatic environmental control system utilizing an Arduino Nano, DHT22 sensor, and PWM-based regulation mapped to dynamic LED indicator ranges.",
        image: "",
        technologies: ["Arduino Nano", "DHT22", "PWM", "LED"],
        demo: "",
        repo: "",
      },
      {
        title: "Adaptive Headlight Intensity Control System",
        description:
          "Built an Arduino-controlled adaptive lighting array using an LDR sensor on an RC car to automate brightness optimization, reducing incoming glare and improving safety.",
        image: "",
        technologies: ["Arduino", "LDR", "Embedded", "Adaptive"],
        demo: "",
        repo: "",
      },
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "haricharan@engineer: ~/portfolio";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    subtitle.textContent = "Hari Charan — Interactive Terminal Resume";
    ...
    role.textContent = "EEE Engineer • Renewable Energy • Embedded Systems";
    ...
    url.textContent = "hari2006charan@gmail.com";
